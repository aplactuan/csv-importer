<x-app-layout>
    ...
    <div class="py-12">
        ...
        <livewire:csv-importer
            ...
            :columnsToMap="['id', 'first_name', 'last_name', 'email']"
            :requiredColumn="['id', 'first_name', 'last_name', 'email']"
            :columnLabels="['id' => 'ID', 'first_name' => 'First Name', 'last_name' => 'Last Name', 'email' => 'Email']"
        />
    </div>
</x-app-layout>
